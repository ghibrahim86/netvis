# This module is stolen from the Internet
# (www.sourcecodeonline.come/details/tooltip_for_tkinter.html).
#
# It implements the ToolTip class and can be used for a wide range of widgets
# in python Tkinter library.  (What a shame that Tkinter does not have a
# tooltip widget...)

from Tkinter import *
from time import time, localtime, strftime

class LineToolTip( Toplevel ):
    """
    Provides a ToolTip widget for Tkinter.
    To apply a ToolTip to any Tkinter widget, simply pass the widget to the
    ToolTip constructor
    """ 
    def __init__( self, canvas, line, msg=None, msgFunc=None, delay=1, follow=True ):
        """
        ...
        self.canvas = canvas
        self.line = line
        Toplevel.__init__( self, self.canvas, bg='black', padx=1, pady=1 )      # Initalise the Toplevel
        ...
        self.canvas.tag_bind(self.line, '<Enter>', self.spawn, '+' )                            # Add bindings to the widget.  This will NOT override bindings that the widget already has
        self.canvas.tag_bind(self.line, '<Leave>', self.hide, '+' )
        self.canvas.tag_bind(self.line, '<Motion>', self.move, '+' )
